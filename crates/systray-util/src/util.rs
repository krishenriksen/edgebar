...
impl Util {
  ...
  pub fn icon_to_image(icon: isize) -> crate::Result<RgbaImage> {
    ...
    // --- New white-to-black conversion logic in utils ---
    // Sample a 10x10 region from the top-left of the icon.
    let sample_width = 10.min(width_usize);
